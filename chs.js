...
var cnItems = {
    ...
    "Enter maximal buy price. If everything is setup, turn the auto\n                buyer on. This function will automatically buys all coins you\n                can with the available money. This will happen 1s bevor you get\n                a new stock price!": "输入最高买入价。 如果一切都设置好了，请打开自动购买器。 此功能将自动用可用资金购买您可以\n 购买的所有硬币。 这将在您获得新股票价格之前的 1 秒内发生！",
    "Enter minimal sell price. If everything is setup, turn the auto\n                seller on. This function will automatically sell all coins you\n                have if the sell price is reached. This will happen 1s bevor you\n                get a new stock price!": "输入最低售价。 如果一切都设置好了，打开自动出售器。 如果达到卖出价，此功能将自动卖出您拥有的所有硬币。 这将在您获得新股票价格之前 1 秒发生！",
    "60% chance of increasing your CHAR.": "60% 的几率增加你的 CHAR。",
    "60% chance of increasing your INT.": "60% 的几率增加你的 INT。",
    "Actions": "动作",
    "Auto buy coins if a specific buy Price is reached.": "如果达到特定购买价格，则自动购买硬币。",
    "Auto crypto miner": "自动加密矿工",
    "Auto Save:": "自动保存：",
    "Auto sell coins if a specific sell Price is reached.": "如果达到特定的卖出价格，则自动卖出硬币。",
    "Automatically searches for coins. 10% chance of finding a coin.": "自动搜索硬币。 10% 的几率找到硬币。",
    "Automatically searches for coins. 40% chance of finding a coin.": "自动搜索硬币。 40% 的几率找到一枚硬币。",
    "Automatically searches for coins. 90% chance of finding a coin.": "自动搜索硬币。 90% 的几率找到硬币。",
    ...
    "Cancle": "取消",
    "CHAR": "魅力",
    "Char is short for Charisma.": "Char 是 Charisma（魅力） 的缩写。",
    "Char:": "魅力：",
    "Close": "关闭",
    "Coins:": "硬币：",
    "Console": "安慰",
    "Crypto Manager": "加密管理模拟器",
    "Delete": "删除",
    ...
    "Retired": "退休",
    "SAVE": "保存",
    "Search for coins. 20% chance of finding a coin.": "寻找硬币。 20% 的几率找到一枚硬币。",
    ...
    "Shop": "商店",
    "Status": "状态",
    "Stock Helper: Auto buy coins": "股票助手：自动购买硬币",
    "Stock Helper: Auto sell coins": "股票助手：自动出售硬币",
    "Terminal": "终端",
    "Timer:": "计时器：",
    "Turn On": "打开",
    "With a higher int value, the efficiency will increase and the chance of getting more than 1 coin per autominer will increase.": "使用更高的 int 值，效率会提高，并且每个 autominer 获得超过 1 个硬币的机会也会增加。",
